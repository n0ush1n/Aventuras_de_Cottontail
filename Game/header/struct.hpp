...
Found found;
Maze mazeThings[4] = {{CHANGE_WIDTH(726),CHANGE_HEIGHT(611),CHANGE_WIDTH(3),CHANGE_HEIGHT(4)},{CHANGE_WIDTH(935),CHANGE_HEIGHT(877),5,6},{CHANGE_WIDTH(298),CHANGE_HEIGHT(372),6,4},{NEW_WIDTH(10),NEW_HEIGHT(130),5,6}};//maze items position
...
void level3Start()//initializing level3
{
	...
	//maze positions
	Maze maze[12] = {{NEW_WIDTH(160),NEW_HEIGHT(67), NEW_WIDTH(298),NEW_HEIGHT(117)},{NEW_WIDTH(346),NEW_HEIGHT(64), NEW_WIDTH(377),NEW_HEIGHT(233)}, {NEW_WIDTH(350),NEW_HEIGHT(233), NEW_WIDTH(440),NEW_HEIGHT(287)}, {CHANGE_WIDTH(630),NEW_HEIGHT(189), CHANGE_WIDTH(695),NEW_HEIGHT(260)}, {NEW_WIDTH(0),NEW_HEIGHT(197), CHANGE_WIDTH(490),NEW_HEIGHT(250)}, {CHANGE_WIDTH(390),CHANGE_HEIGHT(445), CHANGE_WIDTH(687),CHANGE_HEIGHT(519)}, {NEW_WIDTH(273),NEW_HEIGHT(381), CHANGE_WIDTH(910),CHANGE_HEIGHT(582)}, {NEW_WIDTH(350),NEW_HEIGHT(383), CHANGE_WIDTH(910),NEW_HEIGHT(640)}, {NEW_WIDTH(236),NEW_HEIGHT(335), NEW_WIDTH(258),NEW_HEIGHT(507)}, {NEW_WIDTH(172),NEW_HEIGHT(455),698,NEW_HEIGHT(507)}, {NEW_WIDTH(172),NEW_HEIGHT(580), NEW_WIDTH(200),NEW_HEIGHT(646)}, {NEW_WIDTH(240),NEW_HEIGHT(585), NEW_WIDTH(315),NEW_HEIGHT(640)}} ;
	//demons position
	Demon demon[5] = {{NEW_WIDTH(200),NEW_HEIGHT(134),NEW_WIDTH(170),NEW_HEIGHT(134),CHANGE_WIDTH(10),2,NEW_WIDTH(225),NEW_HEIGHT(258)},{NEW_WIDTH(335),NEW_HEIGHT(12),NEW_WIDTH(310),NEW_HEIGHT(12),CHANGE_WIDTH(10),2,NEW_WIDTH(390),NEW_HEIGHT(308)},{NEW_WIDTH(190),NEW_HEIGHT(403),NEW_WIDTH(125),NEW_HEIGHT(400),CHANGE_WIDTH(8),1,NEW_WIDTH(220),NEW_HEIGHT(515)},{CHANGE_WIDTH(925),NEW_HEIGHT(389),CHANGE_WIDTH(925),NEW_HEIGHT(389),CHANGE_WIDTH(15),-1,CHANGE_WIDTH(925),NEW_HEIGHT(590)},{NEW_WIDTH(203),NEW_HEIGHT(533),NEW_WIDTH(203),NEW_HEIGHT(533),CHANGE_WIDTH(7),1,NEW_WIDTH(315),NEW_HEIGHT(649)}};
